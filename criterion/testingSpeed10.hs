...
generateTerms [2] = TmVar (generateHnatTermVar 10 Z)
...
genBenchesTerms [] = []
genBenchesTerms (ints:ints2:rest) = ( (generateTerms1 ints) :( genTmAbs (generateTerms ints2) 10 )  : genBenchesTerms rest)
